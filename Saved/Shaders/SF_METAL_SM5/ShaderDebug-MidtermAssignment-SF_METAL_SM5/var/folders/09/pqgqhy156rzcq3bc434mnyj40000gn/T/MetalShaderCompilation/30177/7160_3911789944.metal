...
vertex MainVS_out Main_00001bf8_e9292d78(MainVS_in in [[stage_in]], constant type_View& View [[buffer(0)]], constant type_Primitive& Primitive [[buffer(1)]], constant type_TranslucentDepthPass& TranslucentDepthPass [[buffer(2)]], constant type_Globals& _Globals [[buffer(3)]])
{
    MainVS_out out = {};
    ...
    float4 _265 = float4((((Primitive.Primitive_LocalToWorld[0].xyz * _249.xxx) + (Primitive.Primitive_LocalToWorld[1].xyz * _249.yyy)) + (Primitive.Primitive_LocalToWorld[2].xyz * _249.zzz)) + (Primitive.Primitive_LocalToWorld[3].xyz + View.View_PreViewTranslation), 1.0);
    float4 _266 = float4(_265.x, _265.y, _265.z, _265.w);
    float4 _269 = TranslucentDepthPass.TranslucentDepthPass_ProjectionMatrix * _266;
    float4 _280;
    if ((TranslucentDepthPass.TranslucentDepthPass_bClampToNearPlane != 0.0) && (_269.z < 0.0))
    {
        float4 _278 = _269;
    ...
    float _284 = _280.z * TranslucentDepthPass.TranslucentDepthPass_InvMaxSubjectDepth;
    float4 _287 = _280;
    _287.z = _284 * _280.w;
    spvUnsafeArray<float4, 1> _299 = { float4(in.in_var_ATTRIBUTE4.x, in.in_var_ATTRIBUTE4.y, float4(0.0).z, float4(0.0).w) };
    ...
    out.out_var_TEXCOORD6 = _284;
    out.out_var_TEXCOORD7 = _266;
    out.gl_Position = _287;
