...
fragment InjectMainPS_out Main_00002ca6_0b037873(InjectMainPS_in in [[stage_in]], constant type_View& View [[buffer(0)]], constant type_DeferredLightUniforms& DeferredLightUniforms [[buffer(1)]], constant type_Globals& _Globals [[buffer(2)]], texture2d<float> View_TransmittanceLutTexture [[texture(0)]], texture2d<float> StaticShadowDepthTexture [[texture(1)]], texture2d<float> VolumetricCloudShadowmapTexture [[texture(2)]], sampler View_TransmittanceLutTextureSampler [[sampler(0)]], sampler StaticShadowDepthTextureSampler [[sampler(1)]], sampler VolumetricCloudShadowmapTextureSampler [[sampler(2)]], uint gl_Layer [[render_target_array_index]])
{
