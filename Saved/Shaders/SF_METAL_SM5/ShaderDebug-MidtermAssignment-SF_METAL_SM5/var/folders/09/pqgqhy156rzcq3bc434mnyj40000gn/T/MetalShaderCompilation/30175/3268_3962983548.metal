...
vertex MainForGS_out Main_00000cc4_ec36547c(MainForGS_in in [[stage_in]], constant type_View& View [[buffer(0)]], constant type_ShadowDepthPass& ShadowDepthPass [[buffer(1)]], constant type_Globals& _Globals [[buffer(2)]])
{
    MainForGS_out out = {};
