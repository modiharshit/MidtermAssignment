...
vertex MainVS_out Main_00001df9_6c027eab(MainVS_in in [[stage_in]], constant type_View& View [[buffer(1)]], constant type_Primitive& Primitive [[buffer(2)]], constant type_Globals& _Globals [[buffer(3)]], texture_buffer<float> BoneMatrices [[texture(0)]])
{
    MainVS_out out = {};
    ...
    float3 _273 = (float4(in.in_var_ATTRIBUTE0.xyz + in.in_var_ATTRIBUTE11, 1.0) * _247) + in.in_var_ATTRIBUTE12;
    float4 _300 = float4((((Primitive.Primitive_LocalToWorld[0u].xyz * _273.xxx) + (Primitive.Primitive_LocalToWorld[1u].xyz * _273.yyy)) + (Primitive.Primitive_LocalToWorld[2u].xyz * _273.zzz)) + (Primitive.Primitive_LocalToWorld[3u].xyz + View.View_PreViewTranslation), 1.0);
    ...
    float4 _314 = View.View_TranslatedWorldToClip * float4(_300.x, _300.y, _300.z, _300.w);
    float4 _317 = _73;
    _317.w = 0.0;
    ...
    float4 _353 = _314;
    _353.z = _314.z + (9.9999997473787516355514526367188e-05 * _314.w);
