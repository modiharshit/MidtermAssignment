...
fragment MainPixelShader_out Main_00000c4c_42b5cde1(MainPixelShader_in in [[stage_in]], constant type_View& View [[buffer(0)]], texture2d<float> Material_Texture2D_1 [[texture(0)]], sampler Material_Texture2D_1Sampler [[sampler(0)]])
{
    ...
    float4 _103 = float4(_94.x, _94.y, _51.z, _51.w);
