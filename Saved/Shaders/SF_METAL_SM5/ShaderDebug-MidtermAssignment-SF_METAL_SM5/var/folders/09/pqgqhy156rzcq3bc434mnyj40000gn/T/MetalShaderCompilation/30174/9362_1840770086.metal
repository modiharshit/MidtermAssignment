...
vertex Main_out Main_00002492_6db7ec26(Main_in in [[stage_in]], constant type_View& View [[buffer(4)]], constant type_Primitive& Primitive [[buffer(5)]], constant type_LocalVF& LocalVF [[buffer(6)]], constant type_Globals& _Globals [[buffer(7)]], texture_buffer<float> InstanceVF_VertexFetch_InstanceOriginBuffer [[texture(0)]], texture_buffer<float> InstanceVF_VertexFetch_InstanceTransformBuffer [[texture(1)]], texture_buffer<float> LocalVF_VertexFetch_TexCoordBuffer [[texture(2)]], texture_buffer<float> LocalVF_VertexFetch_PackedTangentsBuffer [[texture(3)]], uint gl_InstanceIndex [[instance_id]], uint gl_VertexIndex [[vertex_id]], uint gl_BaseVertex [[base_vertex]], uint gl_BaseInstance [[base_instance]])
{
    ...
    float4 _273 = float4(_263.x, _263.y, _263.z, _263.w);
    float4 _282 = View.View_TranslatedWorldToClip * _273;
    spvUnsafeArray<float4, 1> _294 = { float4(_272.x, _272.y, float4(0.0).z, float4(0.0).w) };
    out.out_var_TEXCOORD10_centroid = float4(_142[0], 0.0);
    out.out_var_TEXCOORD11_centroid = float4(_142[2], _110 * Primitive.Primitive_InvNonUniformScaleAndDeterminantSign.w);
    out.out_var_COLOR1 = _230;
    out_var_TEXCOORD0 = _294;
    out.out_var_HIT_PROXY_ID = float4((_146 - (256.0 * _148)) * 0.0039215688593685626983642578125, _99.w * 0.0039215688593685626983642578125, _101.w * 0.0039215688593685626983642578125, 0.0);
    out.out_var_TEXCOORD6 = _273;
