...
vertex Main_out Main_0000182e_9edb7090(Main_in in [[stage_in]], constant type_View& View [[buffer(0)]], constant type_Primitive& Primitive [[buffer(1)]], constant type_LandscapeFixedGrid& LandscapeFixedGrid [[buffer(2)]], constant type_LandscapeParameters& LandscapeParameters [[buffer(3)]], texture2d<float> LandscapeParameters_HeightmapTexture [[texture(0)]], sampler LandscapeParameters_HeightmapTextureSampler [[sampler(0)]])
{
    Main_out out = {};
    ...
    float4 _178 = float4(_177.x, _177.y, _177.z, _177.w);
    float4 _181 = View.View_TranslatedWorldToClip * _178;
    float2 _182 = _145.xy;
    ...
    float2 _199 = (((_182 * LandscapeParameters.LandscapeParameters_HeightmapUVScaleBias.xy) + LandscapeParameters.LandscapeParameters_HeightmapUVScaleBias.zw) + _105) + _111;
    out.out_var_TEXCOORD0 = (_182 + LandscapeParameters.LandscapeParameters_SubsectionSizeVertsLayerUVPan.zw) + _147;
