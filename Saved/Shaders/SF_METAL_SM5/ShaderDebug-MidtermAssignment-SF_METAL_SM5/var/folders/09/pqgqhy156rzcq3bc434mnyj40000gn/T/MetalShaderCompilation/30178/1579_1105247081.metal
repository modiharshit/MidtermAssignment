...
fragment MainPixelShader_out Main_0000062b_41e0bb69(MainPixelShader_in in [[stage_in]], constant type_View& View [[buffer(0)]])
{
    ...
    float4 _73 = float4(_64.x, _64.y, _35.z, _35.w);
