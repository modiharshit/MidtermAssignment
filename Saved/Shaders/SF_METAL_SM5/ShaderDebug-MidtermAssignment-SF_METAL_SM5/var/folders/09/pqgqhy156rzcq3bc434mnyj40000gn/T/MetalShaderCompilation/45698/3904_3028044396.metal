...
vertex MainVertexShader_out Main_00000f40_b47c4a6c(MainVertexShader_in in [[stage_in]], constant type_View& View [[buffer(0)]], constant type_Primitive& Primitive [[buffer(1)]], constant type_BeamTrailVF& BeamTrailVF [[buffer(2)]])
{
    ...
    float3 _93 = _92.xyz;
    float4 _94 = float4(_92.x, _92.y, _92.z, _92.w);
    float4 _95 = View.View_TranslatedWorldToClip * _94;
    float3 _109 = View.View_WorldCameraOrigin - _93;
    float3 _116 = _93 - float4((((Primitive.Primitive_LocalToWorld[0u].xyz * in.in_var_ATTRIBUTE1.xxx) + (Primitive.Primitive_LocalToWorld[1u].xyz * in.in_var_ATTRIBUTE1.yyy)) + (Primitive.Primitive_LocalToWorld[2u].xyz * in.in_var_ATTRIBUTE1.zzz)) + _87, 1.0).xyz;
