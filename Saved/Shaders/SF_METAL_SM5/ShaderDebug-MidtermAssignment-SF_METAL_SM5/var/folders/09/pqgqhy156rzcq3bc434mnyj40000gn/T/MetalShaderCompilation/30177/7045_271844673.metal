...
vertex VSMain_out Main_00001b85_10340541(VSMain_in in [[stage_in]], constant type_View& View [[buffer(0)]], constant type_Primitive& Primitive [[buffer(1)]], constant type_LandscapeFixedGrid& LandscapeFixedGrid [[buffer(2)]], constant type_LandscapeParameters& LandscapeParameters [[buffer(3)]], constant type_Globals& _Globals [[buffer(4)]], texture2d<float> LandscapeParameters_HeightmapTexture [[texture(0)]], sampler LandscapeParameters_HeightmapTextureSampler [[sampler(0)]])
{
    VSMain_out out = {};
    ...
    float2 _188 = _154.xy;
    float3x3 _201 = float3x3(Primitive.Primitive_WorldToLocal[0].xyz, Primitive.Primitive_WorldToLocal[1].xyz, Primitive.Primitive_WorldToLocal[2].xyz);
    float3 _202 = _201 * float3(0.0);
    float3 _203 = _202 * float3(0.0, 0.0, 1.0);
    ...
    float3 _212 = _211 * _203;
    float3 _213 = _187.xyz;
    float3 _214 = _213 + _212;
    float4 _215 = float4(_214.x, _214.y, _214.z, _187.w);
    float2 _224 = ((_188 * LandscapeParameters.LandscapeParameters_WeightmapUVScaleBias.xy) + LandscapeParameters.LandscapeParameters_WeightmapUVScaleBias.zw) + (in.in_var_ATTRIBUTE0.zw * LandscapeParameters.LandscapeParameters_SubsectionOffsetParams.zz);
    float2 _228 = (((_188 * LandscapeParameters.LandscapeParameters_HeightmapUVScaleBias.xy) + LandscapeParameters.LandscapeParameters_HeightmapUVScaleBias.zw) + _114) + _120;
    float4 _230 = View.View_TranslatedWorldToClip * _215;
    float4 _235 = float4(_Globals.RenderOffset, 0.0, 0.0);
    float4 _236 = _230 + _235;
    out.gl_Position = _236;
    out.out_var_TEXCOORD0 = (_188 + LandscapeParameters.LandscapeParameters_SubsectionSizeVertsLayerUVPan.zw) + _156;
