...
vertex MainForGS_out Main_00007b8c_c8a3fdd0(MainForGS_in in [[stage_in]], constant type_View& View [[buffer(4)]], constant type_Primitive& Primitive [[buffer(5)]], constant type_ShadowDepthPass& ShadowDepthPass [[buffer(6)]], constant type_NiagaraSpriteVFLooseParameters& NiagaraSpriteVFLooseParameters [[buffer(7)]], constant type_NiagaraSpriteVF& NiagaraSpriteVF [[buffer(8)]], constant type_Globals& _Globals [[buffer(9)]], texture_buffer<float> NiagaraSpriteVFLooseParameters_CutoutGeometry [[texture(0)]], texture_buffer<float> NiagaraSpriteVFLooseParameters_NiagaraParticleDataFloat [[texture(1)]], texture_buffer<float> NiagaraSpriteVFLooseParameters_NiagaraParticleDataHalf [[texture(2)]], texture_buffer<int> NiagaraSpriteVFLooseParameters_SortedIndices [[texture(3)]], uint gl_VertexIndex [[vertex_id]], uint gl_InstanceIndex [[instance_id]], uint gl_BaseVertex [[base_vertex]], uint gl_BaseInstance [[base_instance]])
{
    ...
    float3 _693 = View.View_WorldCameraOrigin - _235;
    float _694 = length(_693);
    float _695 = fast::max(_694, 9.9999999747524270787835121154785e-07);
    float3 _696 = float3(_695);
    float3 _697 = _693 / _696;
    float _734;
    switch (0u)
    {
        default:
        {
            ...
            {
                _734 = NiagaraSpriteVF.NiagaraSpriteVF_DefaultCamOffset;
                break;
            }
            float _733;
            switch (0u)
            {
                default:
                {
                    uint _709 = uint(NiagaraSpriteVF.NiagaraSpriteVF_CameraOffsetDataOffset);
                    int _713 = int(_709 & 2147483647u);
                    if ((_709 & 2147483648u) != 0u)
                    {
                        _733 = NiagaraSpriteVFLooseParameters_NiagaraParticleDataHalf.read(uint(((uint(_713) * NiagaraSpriteVFLooseParameters.NiagaraSpriteVFLooseParameters_NiagaraFloatDataStride) + _144))).x;
                        break;
                    }
                    else
                    {
                        _733 = NiagaraSpriteVFLooseParameters_NiagaraParticleDataFloat.read(uint(((uint(_713) * NiagaraSpriteVFLooseParameters.NiagaraSpriteVFLooseParameters_NiagaraFloatDataStride) + _144))).x;
                        break;
                    }
                }
            }
    ...
    float3 _735 = _697 * _734;
    float4 _738 = float4(_324, _273, _451);
    float _739 = length(_414);
    float3 _747 = float3(NiagaraSpriteVF.NiagaraSpriteVF_RemoveHMDRoll);
    float3 _748 = mix(View.View_ViewRight, View.View_HMDViewNoRollRight, _747);
    float3 _749 = mix(View.View_ViewUp, View.View_HMDViewNoRollUp, _747);
    float3 _750 = -_749;
    float3 _751 = -View.View_ViewForward;
    bool _754 = NiagaraSpriteVFLooseParameters.NiagaraSpriteVFLooseParameters_ParticleFacingMode == 2u;
    bool3 _755 = bool3(_754);
    float3 _756 = select(_697, _542 / float3(fast::max(length(_542), 9.9999999747524270787835121154785e-07)), _755);
    float3 _762 = mix(select(float3(0.0, 0.0, 1.0), _414 / float3(_739), bool3(_739 > 9.9999999747524270787835121154785e-07)), _637 / float3(fast::max(length(_637), 9.9999999747524270787835121154785e-07)), float3(float(NiagaraSpriteVFLooseParameters.NiagaraSpriteVFLooseParameters_ParticleAlignmentMode == 2u)));
    float3 _763 = cross(_756, _762);
    float3 _767 = _763 / float3(fast::max(length(_763), 9.9999999747524270787835121154785e-07));
    float3 _773 = cross(_751, _749);
    float3 _777 = _773 / float3(fast::max(length(_773), 9.9999999747524270787835121154785e-07));
    float3 _779 = cross(_756, _749);
    float3 _783 = _779 / float3(fast::max(length(_779), 9.9999999747524270787835121154785e-07));
    float3 _785 = cross(_697, float3(0.0, 0.0, 1.0));
    ...
    if (NiagaraSpriteVFLooseParameters.NiagaraSpriteVFLooseParameters_ParticleAlignmentMode == 0u)
    {
        ...
        {
            float3 _822 = float3(fast::clamp((dot(_693, _693) * NiagaraSpriteVF.NiagaraSpriteVF_CameraFacingBlend[1]) - NiagaraSpriteVF.NiagaraSpriteVF_CameraFacingBlend[2], 0.0, 1.0));
            _825 = mix(cross(_697, _785), _750, _822);
            _826 = mix(_785, _748, _822);
        }
        else
        {
            float3 _811;
            ...
            else
            {
                ...
                {
                    _809 = cross(_751, _777);
                    _810 = _777;
                }
                else
                {
                    _809 = select(cross(_697, _789), cross(_756, _783), _755);
                    _810 = select(_789, _783, _755);
                }
                _811 = _809;
                _812 = _810;
            }
    ...
    {
        _827 = mix(-_762, cross(_756, _767), float3(float(_754)));
        _828 = _767;
    }
    float _831 = _273 * NiagaraSpriteVF.NiagaraSpriteVF_RotationScale;
    float _834 = _831 + NiagaraSpriteVF.NiagaraSpriteVF_RotationBias;
    float _835 = sin(_834);
    float _836 = cos(_834);
    float3 _837 = _828 * _835;
    float3 _838 = _827 * _835;
    float3 _839 = _828 * _836;
    float3 _840 = _827 * _836;
    float3 _841 = _838 + _839;
    float3 _842 = _840 - _837;
    float2 _845 = float2(int2(sign(_324)));
    float2 _885;
    if (NiagaraSpriteVFLooseParameters.NiagaraSpriteVFLooseParameters_NumCutoutVerticesPerFrame > 0u)
    {
        uint _854 = (gl_VertexIndex - gl_BaseVertex) & ((NiagaraSpriteVFLooseParameters.NiagaraSpriteVFLooseParameters_NumCutoutVerticesPerFrame == 8u) ? 7u : 3u);
        float _862 = _845.x;
        float _863 = _845.y;
        uint _870;
        if ((_862 * _863) < 0.0)
        {
            _870 = (NiagaraSpriteVFLooseParameters.NiagaraSpriteVFLooseParameters_NumCutoutVerticesPerFrame - 1u) - _854;
        }
        else
        {
            _870 = _854;
        }
        float4 _874 = NiagaraSpriteVFLooseParameters_CutoutGeometry.read(uint(((uint(mod(_451, NiagaraSpriteVF.NiagaraSpriteVF_SubImageSize.x * NiagaraSpriteVF.NiagaraSpriteVF_SubImageSize.y)) * NiagaraSpriteVFLooseParameters.NiagaraSpriteVFLooseParameters_NumCutoutVerticesPerFrame) + _870)));
        float _876 = _874.x;
        float2 _879 = _95;
        _879.x = (_862 < 0.0) ? (1.0 - _876) : _876;
        float _881 = _874.y;
        float2 _884 = _879;
        _884.y = (_863 < 0.0) ? (1.0 - _881) : _881;
        _885 = _884;
    }
    else
    {
        _885 = in.in_var_ATTRIBUTE0;
    }
    float2 _886 = _738.xy;
    float2 _887 = abs(_886);
    float2x3 _888 = float2x3(_841, _842);
    float2 _889 = _885 - _692;
    float2 _890 = _887 * _889;
    float3 _891 = _888 * _890;
    float3 _892 = _735 + _891;
    float3 _893 = _235 + _892;
    float3x3 _899 = _96;
    _899[0] = _841;
    float3x3 _900 = _899;
    _900[1] = _842;
    bool _903 = NiagaraSpriteVF.NiagaraSpriteVF_NormalsType < 0.5;
    float3x3 _934;
    if (_903)
    {
        float3x3 _933 = _900;
        _933[2] = normalize(cross(_841, _842));
        _934 = _933;
    }
    else
    {
        ...
        {
            float3x3 _929 = _900;
            _929[2] = normalize(_235 - NiagaraSpriteVF.NiagaraSpriteVF_NormalsSphereCenter.xyz);
            _930 = _929;
        }
        else
        {
            float3x3 _923 = _900;
            _923[2] = normalize(_235 - (NiagaraSpriteVF.NiagaraSpriteVF_NormalsSphereCenter.xyz + (NiagaraSpriteVF.NiagaraSpriteVF_NormalsCylinderUnitDirection.xyz * dot(NiagaraSpriteVF.NiagaraSpriteVF_NormalsCylinderUnitDirection.xyz, _235 - NiagaraSpriteVF.NiagaraSpriteVF_NormalsSphereCenter.xyz))));
            _930 = _923;
        }
        _934 = _930;
    }
    float3 _935 = _893 + View.View_PreViewTranslation;
    float _936 = _935.x;
    float _937 = _935.y;
    float _938 = _935.z;
    float4 _939 = float4(_936, _937, _938, 1.0);
    float3x3 _970;
    if (_903)
    {
        float3x3 _969 = _900;
        _969[2] = normalize(cross(_841, _842));
        _970 = _969;
    }
    else
    {
        ...
        {
            float3x3 _965 = _900;
            _965[2] = normalize(_235 - NiagaraSpriteVF.NiagaraSpriteVF_NormalsSphereCenter.xyz);
            _966 = _965;
        }
        else
        {
            float3x3 _959 = _900;
            _959[2] = normalize(_235 - (NiagaraSpriteVF.NiagaraSpriteVF_NormalsSphereCenter.xyz + (NiagaraSpriteVF.NiagaraSpriteVF_NormalsCylinderUnitDirection.xyz * dot(NiagaraSpriteVF.NiagaraSpriteVF_NormalsCylinderUnitDirection.xyz, _235 - NiagaraSpriteVF.NiagaraSpriteVF_NormalsSphereCenter.xyz))));
            _966 = _959;
        }
        _970 = _966;
    }
    float4 _972 = float4(_939.x, _939.y, _939.z, _939.w);
    float4 _975 = float4(_934[0].x, _934[0].y, _934[0].z, float4(0.0).w);
    _975.w = (NiagaraSpriteVF.NiagaraSpriteVF_SubImageBlendMode == 1) ? fract(_451) : 0.0;
    float4 _990 = ShadowDepthPass.ShadowDepthPass_ShadowViewProjectionMatrices[_Globals.LayerId] * _972;
    out.out_var_TEXCOORD10 = _975;
    out.out_var_TEXCOORD11 = float4(_934[2], float(int(sign(determinant(_934)))));
    out.out_var_TEXCOORD7 = _939.xyz;
    out.out_var_TEXCOORD6 = _990;
    out.out_var_TEXCOORD8 = _970[2];
    out.gl_Layer = _Globals.LayerId;
    out.gl_Position = _990;
    return out;
}
