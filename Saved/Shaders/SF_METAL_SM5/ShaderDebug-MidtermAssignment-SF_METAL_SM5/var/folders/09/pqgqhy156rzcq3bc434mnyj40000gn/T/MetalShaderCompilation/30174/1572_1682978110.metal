...
fragment MainPixelShader_out Main_00000624_6450353e(MainPixelShader_in in [[stage_in]], constant type_View& View [[buffer(0)]])
{
    ...
    float4 _75 = float4(_66.x, _66.y, _37.z, _37.w);
