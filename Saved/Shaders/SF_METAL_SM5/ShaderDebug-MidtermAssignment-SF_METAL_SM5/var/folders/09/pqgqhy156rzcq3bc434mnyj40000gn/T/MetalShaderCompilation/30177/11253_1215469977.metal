...
vertex MainVertexShader_out Main_00002bf5_48729999(MainVertexShader_in in [[stage_in]], constant type_View& View [[buffer(2)]], constant type_Primitive& Primitive [[buffer(3)]], constant type_LandscapeContinuousLODParameters& LandscapeContinuousLODParameters [[buffer(4)]], constant type_LandscapeParameters& LandscapeParameters [[buffer(5)]], texture_buffer<float> LandscapeContinuousLODParameters_SectionLOD [[texture(0)]], texture_buffer<float> LandscapeContinuousLODParameters_SectionLODBias [[texture(1)]], texture2d<float> LandscapeParameters_HeightmapTexture [[texture(2)]], sampler LandscapeParameters_HeightmapTextureSampler [[sampler(0)]])
{
    ...
    float2 _329 = _296.xy;
    float4 _334 = float4(_328.x, _328.y, _328.z, _328.w);
    float4 _335 = View.View_TranslatedWorldToClip * _334;
    float2 _344 = ((_329 * LandscapeParameters.LandscapeParameters_WeightmapUVScaleBias.xy) + LandscapeParameters.LandscapeParameters_WeightmapUVScaleBias.zw) + (in.in_var_ATTRIBUTE0.zw * LandscapeParameters.LandscapeParameters_SubsectionOffsetParams.zz);
    float2 _348 = (((_329 * LandscapeParameters.LandscapeParameters_HeightmapUVScaleBias.xy) + LandscapeParameters.LandscapeParameters_HeightmapUVScaleBias.zw) + _255) + _260;
    out.out_var_TEXCOORD0 = (_329 + LandscapeParameters.LandscapeParameters_SubsectionSizeVertsLayerUVPan.zw) + _298;
    out.out_var_TEXCOORD1 = float4(_344.x, _344.y, _348.x, _348.y);
    out.out_var_TEXCOORD2 = float4(0.0);
    out.out_var_TEXCOORD6 = _334;
