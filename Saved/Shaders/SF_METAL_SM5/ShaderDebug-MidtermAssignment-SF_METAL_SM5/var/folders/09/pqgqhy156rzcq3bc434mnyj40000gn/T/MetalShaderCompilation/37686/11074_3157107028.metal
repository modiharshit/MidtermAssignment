...
vertex Main_out Main_00002b42_bc2da154(Main_in in [[stage_in]], constant type_View& View [[buffer(1)]], constant type_Primitive& Primitive [[buffer(2)]], constant type_SpriteVF& SpriteVF [[buffer(3)]], constant type_Globals& _Globals [[buffer(4)]], texture_buffer<float> CutoutGeometry [[texture(0)]], uint gl_VertexIndex [[vertex_id]], uint gl_BaseVertex [[base_vertex]])
{
    Main_out out = {};
    spvUnsafeArray<float4, 1> out_var_TEXCOORD3 = {};
    float4 _108 = float4(in.in_var_ATTRIBUTE0.xyz, 1.0);
    float4 _111 = Primitive.Primitive_LocalToWorld * _108;
    float3 _117 = _111.xyz;
    ...
    float _220 = in.in_var_ATTRIBUTE2.z * SpriteVF.SpriteVF_RotationScale;
    float _221 = _220 + SpriteVF.SpriteVF_RotationBias;
    float _222 = sin(_221);
    float _223 = cos(_221);
    float3 _224 = _214 * _222;
    float3 _225 = _213 * _223;
    float3 _226 = _224 + _225;
    float3 _227 = _214 * _223;
    float3 _228 = _213 * _222;
    float3 _229 = _227 - _228;
    ...
    float3 _290 = _117 + View.View_PreViewTranslation;
    float _291 = _290.x;
    float _292 = _290.y;
    float _293 = _290.z;
    ...
    float _297 = _226.y;
    float _298 = _226.z;
    float4 _299 = float4(_296, _297, _298, 0.0);
    float _300 = _295.x;
    float _304 = _289.x + SpriteVF.SpriteVF_PivotOffset.x;
    float _305 = _300 * _304;
    float4 _306 = _299 * _305;
    float4 _307 = _294 + _306;
    float _308 = _229.x;
    float _309 = _229.y;
    float _310 = _229.z;
    float4 _311 = float4(_308, _309, _310, 0.0);
    float _312 = _295.y;
    float _316 = _289.y + SpriteVF.SpriteVF_PivotOffset.y;
    float _317 = _312 * _316;
    float4 _318 = _311 * _317;
    float4 _319 = _307 + _318;
    ...
    float _373 = _319.y;
    float _374 = _319.z;
    float4 _375 = float4(_372, _373, _374, 1.0);
    float4 _377 = float4(_375.x, _375.y, _375.z, _375.w);
    float4 _378 = View.View_TranslatedWorldToClip * _377;
    float4 _382 = float4(_371[0].x, _371[0].y, _371[0].z, float4(0.0).w);
    _382.w = _321;
    spvUnsafeArray<float4, 1> _391 = { float4(_335.x, _335.y, float4(0.0).z, float4(0.0).w) };
    ...
    out_var_TEXCOORD3 = _391;
    out.out_var_TEXCOORD6 = _377;
    out.gl_Position = _378;
