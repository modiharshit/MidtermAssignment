...
fragment Main_out Main_000008e1_0a1e7c90(Main_in in [[stage_in]], constant type_Material& Material [[buffer(0)]], texture2d<float> Material_Texture2D_0 [[texture(0)]], sampler View_MaterialTextureBilinearClampedSampler [[sampler(0)]])
{
    Main_out out = {};
