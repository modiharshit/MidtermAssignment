...
fragment MainPixelShader_out Main_00000624_e73c6c5f(MainPixelShader_in in [[stage_in]], constant type_View& View [[buffer(0)]])
{
    ...
    float4 _74 = float4(_65.x, _65.y, _36.z, _36.w);
