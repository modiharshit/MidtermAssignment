...
fragment MainPS_out Main_00003c67_cbb0323e(MainPS_in in [[stage_in]], constant uint* spvBufferSizeConstants [[buffer(4)]], const device type_StructuredBuffer_v4float& View_PrimitiveSceneData [[buffer(0)]], const device type_StructuredBuffer_v4float& View_LightmapSceneData [[buffer(1)]], constant type_View& View [[buffer(2)]], constant type_Material& Material [[buffer(3)]], texture2d<float> OpaqueBasePass_DBufferATexture [[texture(0)]], texture2d<float> OpaqueBasePass_DBufferBTexture [[texture(1)]], texture2d<float> OpaqueBasePass_DBufferCTexture [[texture(2)]], texture2d<float> LightmapResourceCluster_LightMapTexture [[texture(3)]], texture2d<float> Material_Texture2D_0 [[texture(4)]], texture2d<float> Material_Texture2D_1 [[texture(5)]], texture2d<float> Material_Texture2D_2 [[texture(6)]], sampler OpaqueBasePass_DBufferATextureSampler [[sampler(0)]], sampler LightmapResourceCluster_LightMapSampler [[sampler(1)]], sampler Material_Texture2D_0Sampler [[sampler(2)]], sampler Material_Texture2D_1Sampler [[sampler(3)]], sampler Material_Texture2D_2Sampler [[sampler(4)]], float4 gl_FragCoord [[position]])
{
    ...
    uint _510 = in.in_var_LIGHTMAP_ID * 15u;
    float3 _520 = (_506.xyz * View_LightmapSceneData._m0[spvStorageBufferCoords(1, spvBufferSizeConstants, float4, _510 + 4u)].xyz) + View_LightmapSceneData._m0[spvStorageBufferCoords(1, spvBufferSizeConstants, float4, _510 + 6u)].xyz;
    float _521 = dot(_520, float3(0.300000011920928955078125, 0.589999973773956298828125, 0.10999999940395355224609375));
    float _540 = (exp2((_521 * 16.0) - 8.0) - 0.00390625) * fast::max(0.0, dot((_508 * View_LightmapSceneData._m0[spvStorageBufferCoords(1, spvBufferSizeConstants, float4, _510 + 5u)]) + View_LightmapSceneData._m0[spvStorageBufferCoords(1, spvBufferSizeConstants, float4, _510 + 7u)], float4(_452.yzx, 1.0)));
    float3 _550 = float4(_520 * (_540 / _521), _540).xyz * View.View_IndirectLightingColorScale;
    float3 _572 = fast::max(mix(float3(0.0), Material.Material_VectorExpressions[1].xyz, float3(Material.Material_ScalarExpressions[0].y)), float3(0.0));
    float3 _601;
    ...
    float4 _608 = float4(((mix(float3(0.0), _482 + (_484 * 0.449999988079071044921875), float3(View.View_UnlitViewmodeMask)) + ((_550 * _482) * fast::max(float3(1.0), ((((((_451 * 2.040400028228759765625) - float3(0.3323999941349029541015625)) * 1.0) + ((_451 * (-4.79510021209716796875)) + float3(0.6417000293731689453125))) * 1.0) + ((_451 * 2.755199909210205078125) + float3(0.69029998779296875))) * 1.0))) + _601) * 1.0, 0.0);
    float4 _615;
    ...
    float3 _627 = (_452 * 0.5) + float3(0.5);
    float4 _629 = float4(_627.x, _627.y, _627.z, float4(0.0).w);
    _629.w = View_PrimitiveSceneData._m0[spvStorageBufferCoords(0, spvBufferSizeConstants, float4, _400)].y;
