...
fragment MainPS_out Main_00004240_eb5c5d96(MainPS_in in [[stage_in]], constant uint* spvBufferSizeConstants [[buffer(5)]], const device type_StructuredBuffer_v4float& View_PrimitiveSceneData [[buffer(0)]], const device type_StructuredBuffer_v4float& View_SkyIrradianceEnvironmentMap [[buffer(1)]], constant type_View& View [[buffer(2)]], constant type_IndirectLightingCache& IndirectLightingCache [[buffer(3)]], constant type_Material& Material [[buffer(4)]], texture3d<uint> View_VolumetricLightmapIndirectionTexture [[texture(0)]], texture3d<float> View_DirectionalLightShadowingBrickTexture [[texture(1)]], texture2d<float> OpaqueBasePass_DBufferATexture [[texture(2)]], texture2d<float> OpaqueBasePass_DBufferBTexture [[texture(3)]], texture2d<float> OpaqueBasePass_DBufferCTexture [[texture(4)]], texture3d<float> IndirectLightingCache_IndirectLightingCacheTexture0 [[texture(5)]], texture3d<float> IndirectLightingCache_IndirectLightingCacheTexture1 [[texture(6)]], texture3d<float> IndirectLightingCache_IndirectLightingCacheTexture2 [[texture(7)]], sampler View_SharedBilinearClampedSampler [[sampler(0)]], sampler OpaqueBasePass_DBufferATextureSampler [[sampler(1)]], sampler IndirectLightingCache_IndirectLightingCacheTextureSampler0 [[sampler(2)]], float4 gl_FragCoord [[position]])
{
    MainPS_out out = {};
    ...
    float _235 = (0.64999997615814208984375 * View.View_RoughnessOverrideParameter.y) + View.View_RoughnessOverrideParameter.x;
    ...
    if ((View_PrimitiveSceneData._m0[spvStorageBufferCoords(0, spvBufferSizeConstants, float4, _237)].x > 0.0) && (View.View_ShowDecalsMask > 0.0))
    {
        ...
        _288 = _275 + _265.x;
        _289 = (float3(0.180000007152557373046875) * _259.w) + _259.xyz;
    ...
    else
    {
        ...
        _287 = 0.5;
        _288 = 1.0;
        _289 = float3(0.180000007152557373046875);
        _290 = _224;
    }
    ...
    float4 _356 = _355;
    _356.y = 0.0;
    float3 _370 = ((_289 - (_289 * _288)) * View.View_DiffuseOverrideParameter.w) + View.View_DiffuseOverrideParameter.xyz;
    float3 _377 = (mix(float3(0.07999999821186065673828125 * _287), _289, float3(_288)) * View.View_SpecularOverrideParameter.w) + View.View_SpecularOverrideParameter.xyz;
    ...
    if (_300)
    {
        float3 _415 = fast::clamp((_216 * IndirectLightingCache.IndirectLightingCache_IndirectLightingCachePrimitiveScale) + IndirectLightingCache.IndirectLightingCache_IndirectLightingCachePrimitiveAdd, IndirectLightingCache.IndirectLightingCache_IndirectLightingCacheMinUV, IndirectLightingCache.IndirectLightingCache_IndirectLightingCacheMaxUV);
        ...
        float4 _444 = _153;
        _444.y = (-0.48860299587249755859375) * _290.y;
        float4 _447 = _444;
        _447.z = 0.48860299587249755859375 * _290.z;
        float4 _450 = _447;
        _450.w = (-0.48860299587249755859375) * _290.x;
        float4 _451 = _450;
    ...
    if (View.View_SkyLightApplyPrecomputedBentNormalShadowingFlag != 0.0)
    {
        ...
        _489 = mix(fast::clamp(dot(_479, _290), 0.0, 1.0), 1.0, _483);
        _490 = _480;
        _491 = mix(_479, _290, float3(_483));
    }
    else
    {
        _489 = 1.0;
    ...
    float4 _595 = float4(((mix(float3(0.0), _385 + (_387 * 0.449999988079071044921875), float3(View.View_UnlitViewmodeMask)) + ((_537 * _385) * fast::max(float3(1.0), ((((((_289 * 2.040400028228759765625) - float3(0.3323999941349029541015625)) * 1.0) + ((_289 * (-4.79510021209716796875)) + float3(0.6417000293731689453125))) * 1.0) + ((_289 * 2.755199909210205078125) + float3(0.69029998779296875))) * 1.0))) + _588) * 1.0, 0.0);
    float4 _602;
    ...
    float3 _614 = (_290 * 0.5) + float3(0.5);
    float4 _616 = float4(_614.x, _614.y, _614.z, float4(0.0).w);
    _616.w = View_PrimitiveSceneData._m0[spvStorageBufferCoords(0, spvBufferSizeConstants, float4, _237)].y;
    float4 _617 = float4(0.0);
    _617.x = _288;
    float4 _618 = _617;
    _618.y = _287;
    float4 _619 = _618;
    _619.z = fast::clamp(_286, 0.0, 0.996078431606292724609375);
    float4 _620 = _619;
    _620.w = 0.517647087574005126953125;
    float4 _632 = float4(_289.x, _289.y, _289.z, float4(0.0).w);
