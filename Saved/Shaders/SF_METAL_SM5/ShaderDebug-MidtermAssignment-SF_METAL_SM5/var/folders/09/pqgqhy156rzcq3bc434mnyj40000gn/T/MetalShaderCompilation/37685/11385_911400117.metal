...
vertex MainVS_out Main_00002c79_3652dcb5(MainVS_in in [[stage_in]], constant type_View& View [[buffer(1)]], constant type_Primitive& Primitive [[buffer(2)]], constant type_TranslucentDepthPass& TranslucentDepthPass [[buffer(3)]], constant type_EmitterDynamicUniforms& EmitterDynamicUniforms [[buffer(4)]], constant type_EmitterUniforms& EmitterUniforms [[buffer(5)]], constant type_Globals& _Globals [[buffer(6)]], texture_buffer<float> ParticleIndices [[texture(0)]], texture2d<float> PositionTexture [[texture(1)]], texture2d<float> VelocityTexture [[texture(2)]], texture2d<float> AttributesTexture [[texture(3)]], texture2d<float> CurveTexture [[texture(4)]], sampler PositionTextureSampler [[sampler(0)]], sampler VelocityTextureSampler [[sampler(1)]], sampler AttributesTextureSampler [[sampler(2)]], sampler CurveTextureSampler [[sampler(3)]], uint gl_VertexIndex [[vertex_id]], uint gl_InstanceIndex [[instance_id]], uint gl_BaseVertex [[base_vertex]], uint gl_BaseInstance [[base_instance]])
{
    ...
    float _430 = _426.z * TranslucentDepthPass.TranslucentDepthPass_InvMaxSubjectDepth;
    float4 _433 = _426;
    _433.z = _430 * _426.w;
    float3 _435 = float3(0.0);
    _435.x = _229;
    float3 _436 = _435;
    _436.y = _144;
    float3 _437 = _436;
    ...
    float3x3 _439 = _438;
    _439[1] = _393;
    float3 _441 = normalize(cross(_390, _393));
    float3x3 _442 = _439;
    _442[2] = _441;
    out.out_var_PARTICLE_SUBUVS = float4(_247.x, _247.y, _250.x, _250.y);
    out.out_var_TEXCOORD4 = _437;
    ...
    out.out_var_TANGENTZ = float4(_441, float(int(sign(determinant(_442)))));
    out.out_var_TEXCOORD6 = _430;
    out.out_var_TEXCOORD7 = _412;
    out.gl_Position = _433;
    return out;
}
