...
fragment MainOpacityPS_out Main_00000583_fb484b6d(MainOpacityPS_in in [[stage_in]], constant type_TranslucentDepthPass& TranslucentDepthPass [[buffer(0)]], constant type_Globals& _Globals [[buffer(1)]])
{
    ...
    out.out_var_SV_Target0 = float4(-0.0, cos(_49) * (-0.0));
    out.out_var_SV_Target1 = float4(0.0, sin(_49) * (-0.0));
    return out;
}
