...
fragment MainPS_out Main_00006467_beb97357(MainPS_in in [[stage_in]], constant uint* spvBufferSizeConstants [[buffer(4)]], const device type_StructuredBuffer_v4float& View_PrimitiveSceneData [[buffer(0)]], const device type_StructuredBuffer_v4float& View_LightmapSceneData [[buffer(1)]], constant type_View& View [[buffer(2)]], constant type_Material& Material [[buffer(3)]], texture2d<float> OpaqueBasePass_DBufferATexture [[texture(0)]], texture2d<float> OpaqueBasePass_DBufferBTexture [[texture(1)]], texture2d<float> OpaqueBasePass_DBufferCTexture [[texture(2)]], texture2d<float> LightmapResourceCluster_LightMapTexture [[texture(3)]], texture2d<float> Material_Texture2D_0 [[texture(4)]], texture2d<float> Material_Texture2D_1 [[texture(5)]], texture2d<float> Material_Texture2D_2 [[texture(6)]], texture2d<float> Material_Texture2D_3 [[texture(7)]], texture2d<float> Material_Texture2D_4 [[texture(8)]], texture2d<float> Material_Texture2D_5 [[texture(9)]], texture2d<float> Material_Texture2D_6 [[texture(10)]], sampler OpaqueBasePass_DBufferATextureSampler [[sampler(0)]], sampler LightmapResourceCluster_LightMapSampler [[sampler(1)]], sampler Material_Texture2D_0Sampler [[sampler(2)]], sampler Material_Texture2D_1Sampler [[sampler(3)]], sampler Material_Texture2D_2Sampler [[sampler(4)]], sampler Material_Texture2D_3Sampler [[sampler(5)]], sampler Material_Texture2D_4Sampler [[sampler(6)]], sampler Material_Texture2D_5Sampler [[sampler(7)]], sampler Material_Texture2D_6Sampler [[sampler(8)]], float4 gl_FragCoord [[position]])
{
    ...
    uint _845 = in.in_var_LIGHTMAP_ID * 15u;
    uint _846 = _845 + 4u;
    uint _851 = _845 + 6u;
    float3 _856 = _837.xyz;
    float3 _884 = ((((_856 * _856) * View_LightmapSceneData._m0[spvStorageBufferCoords(1, spvBufferSizeConstants, float4, _846)].xyz) + View_LightmapSceneData._m0[spvStorageBufferCoords(1, spvBufferSizeConstants, float4, _851)].xyz) * ((exp2(((_837.w + ((_839.w * 0.0039215688593685626983642578125) - 0.00196078442968428134918212890625)) * View_LightmapSceneData._m0[spvStorageBufferCoords(1, spvBufferSizeConstants, float4, _846)].w) + View_LightmapSceneData._m0[spvStorageBufferCoords(1, spvBufferSizeConstants, float4, _851)].w) - 0.0185813605785369873046875) * fast::max(0.0, dot((_839 * View_LightmapSceneData._m0[spvStorageBufferCoords(1, spvBufferSizeConstants, float4, _845 + 5u)]) + View_LightmapSceneData._m0[spvStorageBufferCoords(1, spvBufferSizeConstants, float4, _845 + 7u)], float4(_782.yzx, 1.0))))) * View.View_IndirectLightingColorScale;
    float3 _906 = fast::max(mix(float3(0.0), Material.Material_VectorExpressions[1].xyz, float3(Material.Material_ScalarExpressions[0].x)), float3(0.0));
    float3 _935;
    if (View.View_OutOfBoundsMask > 0.0)
    {
        ...
        {
            _934 = mix(float3(1.0, 1.0, 0.0), float3(0.0, 1.0, 1.0), select(float3(0.0), float3(1.0), float3(fract(dot(_258, float3(0.57700002193450927734375)) * 0.00200000009499490261077880859375)) > float3(0.5)));
        }
        else
        {
            _934 = _906;
    ...
    float4 _942 = float4(((mix(float3(0.0), _812 + (_814 * 0.449999988079071044921875), float3(View.View_UnlitViewmodeMask)) + ((_884 * _812) * fast::max(_823, ((((((_781 * 2.040400028228759765625) - float3(0.3323999941349029541015625)) * _723) + ((_781 * (-4.79510021209716796875)) + float3(0.6417000293731689453125))) * _723) + ((_781 * 2.755199909210205078125) + float3(0.69029998779296875))) * _723))) + _935) * 1.0, 0.0);
    float4 _949;
    ...
    float2 _953 = (fract(gl_FragCoord.xy * float2(0.0078125)) * 128.0) + float2(-64.3406219482421875, -72.4656219482421875);
    float3 _961 = (_782 * 0.5) + float3(0.5);
    float4 _963 = float4(_961.x, _961.y, _961.z, float4(0.0).w);
    _963.w = View_PrimitiveSceneData._m0[spvStorageBufferCoords(0, spvBufferSizeConstants, float4, _730)].y;
    float4 _964 = float4(0.0);
    _964.x = _780;
    float4 _965 = _964;
    _965.y = _779;
    float4 _966 = _965;
    _966.z = _778;
    float4 _967 = _966;
    _967.w = 0.75686275959014892578125;
    float4 _979 = float4(_781.x, _781.y, _781.z, float4(0.0).w);
    _979.w = ((log2(((dot(_884, float3(0.300000011920928955078125, 0.589999973773956298828125, 0.10999999940395355224609375)) * fast::max(_823, ((((((_816 * 2.040400028228759765625) - float3(0.3323999941349029541015625)) * _723) + ((_816 * (-4.79510021209716796875)) + float3(0.6417000293731689453125))) * _723) + ((_816 * 2.755199909210205078125) + float3(0.69029998779296875))) * _723).y) * View.View_PreExposure) + 0.00390625) * 0.0625) + 0.5) + ((fract(dot(_953.xyx * _953.xyy, float3(20.390625, 60.703125, 2.4281208515167236328125))) - 0.5) * 0.0039215688593685626983642578125);
    out.out_var_SV_Target0 = _949 * View.View_PreExposure;
    out.out_var_SV_Target1 = _963;
    out.out_var_SV_Target2 = _967;
    out.out_var_SV_Target3 = _979;
