...
fragment MainPixelShader_out Main_00000df2_d8ab06bb(MainPixelShader_in in [[stage_in]], constant type_LightmapDensityPass& LightmapDensityPass [[buffer(0)]], constant type_Globals& _Globals [[buffer(1)]], texture2d<float> LightmapDensityPass_GridTexture [[texture(0)]], sampler LightmapDensityPass_GridTextureSampler [[sampler(0)]])
{
    ...
    {
        float _85 = LightmapDensityPass.LightmapDensityPass_LightMapDensity.w - LightmapDensityPass.LightmapDensityPass_LightMapDensity.z;
        float _86 = _80 - LightmapDensityPass.LightmapDensityPass_LightMapDensity.z;
        _97 = float4(_86 / _85, (_85 - _86) / _85, 0.0, 1.0);
        _98 = _86;
    }
    else
    {
        ...
        float _92 = _80 - LightmapDensityPass.LightmapDensityPass_LightMapDensity.y;
        _97 = float4(0.0, _92 / _91, (_91 - _92) / _91, 1.0);
        _98 = _92;
    }
