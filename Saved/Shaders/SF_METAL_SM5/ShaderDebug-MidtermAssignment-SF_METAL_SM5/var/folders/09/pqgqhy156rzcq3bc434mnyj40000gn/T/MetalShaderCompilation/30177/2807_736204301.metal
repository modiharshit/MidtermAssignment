...
fragment MainOpacityPS_out Main_00000af7_2be1960d(MainOpacityPS_in in [[stage_in]], constant type_TranslucentDepthPass& TranslucentDepthPass [[buffer(0)]], constant type_Material& Material [[buffer(1)]], constant type_Globals& _Globals [[buffer(2)]])
{
    MainOpacityPS_out out = {};
    float _52 = fast::clamp(Material.Material_ScalarExpressions[0].y, 0.0, 1.0);
