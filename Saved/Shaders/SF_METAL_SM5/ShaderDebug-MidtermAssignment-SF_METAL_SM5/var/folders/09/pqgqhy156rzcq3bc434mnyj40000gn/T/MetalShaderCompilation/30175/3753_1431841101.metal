...
vertex Main_out Main_00000ea9_5558294d(Main_in in [[stage_in]], constant type_View& View [[buffer(0)]], constant type_Primitive& Primitive [[buffer(1)]], constant type_BeamTrailVF& BeamTrailVF [[buffer(2)]])
{
    Main_out out = {};
    ...
    float4 _92 = float4(_91.x, _91.y, _91.z, _91.w);
    float4 _93 = View.View_TranslatedWorldToClip * _92;
    float3 _107 = _91.xyz;
    float3 _108 = View.View_WorldCameraOrigin - _107;
    float3 _115 = _107 - float4((((Primitive.Primitive_LocalToWorld[0u].xyz * in.in_var_ATTRIBUTE1.xxx) + (Primitive.Primitive_LocalToWorld[1u].xyz * in.in_var_ATTRIBUTE1.yyy)) + (Primitive.Primitive_LocalToWorld[2u].xyz * in.in_var_ATTRIBUTE1.zzz)) + _86, 1.0).xyz;
