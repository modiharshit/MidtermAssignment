...
vertex MainVS_out Main_00002b01_52a53588(MainVS_in in [[stage_in]], constant type_View& View [[buffer(1)]], constant type_Primitive& Primitive [[buffer(2)]], constant type_TranslucentDepthPass& TranslucentDepthPass [[buffer(3)]], constant type_SpriteVF& SpriteVF [[buffer(4)]], constant type_Globals& _Globals [[buffer(5)]], texture_buffer<float> CutoutGeometry [[texture(0)]], uint gl_VertexIndex [[vertex_id]], uint gl_BaseVertex [[base_vertex]])
{
    MainVS_out out = {};
    ...
    float _394 = _390.z * TranslucentDepthPass.TranslucentDepthPass_InvMaxSubjectDepth;
    float4 _397 = _390;
    _397.z = _394 * _390.w;
    float4 _401 = float4(_371[0].x, _371[0].y, _371[0].z, float4(0.0).w);
    _401.w = _321;
    spvUnsafeArray<float4, 1> _411 = { float4(_335.x, _335.y, float4(0.0).z, float4(0.0).w) };
    out.out_var_TEXCOORD10 = _401;
    out.out_var_TEXCOORD11 = float4(_371[2], float(int(sign(determinant(_371)))));
    out.out_var_TEXCOORD2 = in.in_var_ATTRIBUTE3;
    out_var_TEXCOORD3 = _411;
