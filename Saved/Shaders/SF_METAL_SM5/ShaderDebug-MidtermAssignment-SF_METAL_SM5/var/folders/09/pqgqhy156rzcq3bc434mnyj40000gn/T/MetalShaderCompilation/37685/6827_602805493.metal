...
vertex MainVS_out Main_00001aab_23ee14f5(MainVS_in in [[stage_in]], constant uint* spvBufferSizeConstants [[buffer(6)]], const device type_StructuredBuffer_v4float& View_PrimitiveSceneData [[buffer(2)]], constant type_View& View [[buffer(3)]], constant type_TranslucentDepthPass& TranslucentDepthPass [[buffer(4)]], constant type_LocalVF& LocalVF [[buffer(5)]], texture_buffer<float> LocalVF_VertexFetch_TexCoordBuffer [[texture(0)]], texture_buffer<float> LocalVF_VertexFetch_PackedTangentsBuffer [[texture(1)]], uint gl_VertexIndex [[vertex_id]], uint gl_BaseVertex [[base_vertex]])
{
    MainVS_out out = {};
    ...
    float4 _146 = float4(_145.x, _145.y, _145.z, _145.w);
    float4 _149 = TranslucentDepthPass.TranslucentDepthPass_ProjectionMatrix * _146;
    float4 _160;
    if ((TranslucentDepthPass.TranslucentDepthPass_bClampToNearPlane != 0.0) && (_149.z < 0.0))
    {
        float4 _158 = _149;
        _158.z = 9.9999999747524270787835121154785e-07;
        float4 _159 = _158;
        _159.w = 1.0;
        _160 = _159;
    }
    ...
    float _164 = _160.z * TranslucentDepthPass.TranslucentDepthPass_InvMaxSubjectDepth;
    float4 _167 = _160;
    _167.z = _164 * _160.w;
    float4 _173 = LocalVF_VertexFetch_TexCoordBuffer.read(uint((uint(LocalVF.LocalVF_VertexFetch_Parameters.y) * _77)));
    spvUnsafeArray<float4, 1> _185 = { float4(_173.x, _173.y, float4(0.0).z, float4(0.0).w) };
    ...
    out_var_TEXCOORD0 = _185;
    out.out_var_PRIMITIVE_ID = in.in_var_ATTRIBUTE13;
    out.out_var_TEXCOORD6 = _164;
    out.out_var_TEXCOORD7 = _146;
    out.gl_Position = _167;
