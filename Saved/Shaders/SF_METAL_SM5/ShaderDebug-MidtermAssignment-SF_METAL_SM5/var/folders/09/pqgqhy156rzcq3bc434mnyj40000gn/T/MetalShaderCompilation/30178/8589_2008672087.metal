...
vertex MainVS_out Main_0000218d_77b9e757(MainVS_in in [[stage_in]], constant type_View& View [[buffer(1)]], constant type_Primitive& Primitive [[buffer(2)]], constant type_TranslucentDepthPass& TranslucentDepthPass [[buffer(3)]], constant type_Globals& _Globals [[buffer(4)]], texture_buffer<float> BoneMatrices [[texture(0)]])
{
    MainVS_out out = {};
    ...
    float _335 = _331.z * TranslucentDepthPass.TranslucentDepthPass_InvMaxSubjectDepth;
    float4 _338 = _331;
    _338.z = _335 * _331.w;
    float4 _341 = _79;
    _341.w = 0.0;
    float3x3 _354 = float3x3(Primitive.Primitive_LocalToWorld[0].xyz, Primitive.Primitive_LocalToWorld[1].xyz, Primitive.Primitive_LocalToWorld[2].xyz);
    _354[0] = Primitive.Primitive_LocalToWorld[0].xyz * Primitive.Primitive_InvNonUniformScaleAndDeterminantSign.x;
    float3x3 _357 = _354;
    _357[1] = Primitive.Primitive_LocalToWorld[1].xyz * Primitive.Primitive_InvNonUniformScaleAndDeterminantSign.y;
    float3x3 _360 = _357;
    _360[2] = Primitive.Primitive_LocalToWorld[2].xyz * Primitive.Primitive_InvNonUniformScaleAndDeterminantSign.z;
    float3x3 _361 = _360 * _272;
    float3 _362 = _361[0];
    spvUnsafeArray<float4, 1> _372 = { float4(_82[0].x, _82[0].y, float4(0.0).z, float4(0.0).w) };
    out.out_var_TEXCOORD10_centroid = float4(_362.x, _362.y, _362.z, _341.w);
    out.out_var_TEXCOORD11_centroid = float4(_361[2], in.in_var_ATTRIBUTE2.w * Primitive.Primitive_InvNonUniformScaleAndDeterminantSign.w);
    out_var_TEXCOORD0 = _372;
    out.out_var_TEXCOORD6 = _335;
