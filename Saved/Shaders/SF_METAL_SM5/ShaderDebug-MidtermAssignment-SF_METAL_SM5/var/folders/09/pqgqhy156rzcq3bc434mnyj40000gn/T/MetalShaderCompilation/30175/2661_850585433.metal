...
vertex Main_out Main_00000a65_32b2e759(Main_in in [[stage_in]], constant type_View& View [[buffer(0)]], constant type_ShadowDepthPass& ShadowDepthPass [[buffer(1)]])
{
    Main_out out = {};
    ...
    out.out_var_TEXCOORD6 = _94.z;
    out.out_var_TEXCOORD8 = (ShadowDepthPass.ShadowDepthPass_ShadowParams.y * fast::clamp((abs(_100) > 0.0) ? (sqrt(fast::clamp(1.0 - (_100 * _100), 0.0, 1.0)) / _100) : ShadowDepthPass.ShadowDepthPass_ShadowParams.z, 0.0, ShadowDepthPass.ShadowDepthPass_ShadowParams.z)) + ShadowDepthPass.ShadowDepthPass_ShadowParams.x;
    out.gl_Position = _94;
    return out;
}
