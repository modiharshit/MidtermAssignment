...
fragment MainOpacityPS_out Main_000009d1_9989a175(MainOpacityPS_in in [[stage_in]], constant type_Material& Material [[buffer(0)]], constant type_Globals& _Globals [[buffer(1)]])
{
    MainOpacityPS_out out = {};
    float _49 = fast::clamp(Material.Material_ScalarExpressions[0].w, 0.0, 1.0);
