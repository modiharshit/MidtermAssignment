...
vertex MainVertexShader_out Main_0000189f_a2714b87(MainVertexShader_in in [[stage_in]], constant type_View& View [[buffer(0)]], constant type_Primitive& Primitive [[buffer(1)]], constant type_LandscapeFixedGrid& LandscapeFixedGrid [[buffer(2)]], constant type_LandscapeParameters& LandscapeParameters [[buffer(3)]], texture2d<float> LandscapeParameters_HeightmapTexture [[texture(0)]], sampler LandscapeParameters_HeightmapTextureSampler [[sampler(0)]])
{
    ...
    float2 _180 = _147.xy;
    float4 _185 = float4(_179.x, _179.y, _179.z, _179.w);
    float4 _186 = View.View_TranslatedWorldToClip * _185;
    float2 _195 = ((_180 * LandscapeParameters.LandscapeParameters_WeightmapUVScaleBias.xy) + LandscapeParameters.LandscapeParameters_WeightmapUVScaleBias.zw) + (in.in_var_ATTRIBUTE0.zw * LandscapeParameters.LandscapeParameters_SubsectionOffsetParams.zz);
    float2 _199 = (((_180 * LandscapeParameters.LandscapeParameters_HeightmapUVScaleBias.xy) + LandscapeParameters.LandscapeParameters_HeightmapUVScaleBias.zw) + _107) + _113;
    out.out_var_TEXCOORD0 = (_180 + LandscapeParameters.LandscapeParameters_SubsectionSizeVertsLayerUVPan.zw) + _149;
