...
vertex Main_out Main_00000fbf_e4be5c52(Main_in in [[stage_in]], constant type_View& View [[buffer(0)]], constant type_Primitive& Primitive [[buffer(1)]], constant type_ShadowDepthPass& ShadowDepthPass [[buffer(2)]], constant type_BeamTrailVF& BeamTrailVF [[buffer(3)]])
{
    Main_out out = {};
    ...
    float4 _199 = _168;
    _199.z = ((_168.z * ShadowDepthPass.ShadowDepthPass_ShadowParams.w) + ((ShadowDepthPass.ShadowDepthPass_ShadowParams.y * fast::clamp((abs(_174) > 0.0) ? (sqrt(fast::clamp(1.0 - (_174 * _174), 0.0, 1.0)) / _174) : ShadowDepthPass.ShadowDepthPass_ShadowParams.z, 0.0, ShadowDepthPass.ShadowDepthPass_ShadowParams.z)) + ShadowDepthPass.ShadowDepthPass_ShadowParams.x)) * _168.w;
    out.out_var_TEXCOORD6 = 0.0;
    out.gl_Position = _199;
    return out;
}
