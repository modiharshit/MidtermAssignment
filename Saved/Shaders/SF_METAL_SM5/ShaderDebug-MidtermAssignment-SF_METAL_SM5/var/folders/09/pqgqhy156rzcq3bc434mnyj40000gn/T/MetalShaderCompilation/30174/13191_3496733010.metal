...
vertex MainVertexShader_out Main_00003387_d06be952(MainVertexShader_in in [[stage_in]], constant type_View& View [[buffer(2)]], constant type_Primitive& Primitive [[buffer(3)]], constant type_LandscapeContinuousLODParameters& LandscapeContinuousLODParameters [[buffer(4)]], constant type_LandscapeParameters& LandscapeParameters [[buffer(5)]], texture_buffer<float> LandscapeContinuousLODParameters_SectionLOD [[texture(0)]], texture_buffer<float> LandscapeContinuousLODParameters_SectionLODBias [[texture(1)]], texture2d<float> LandscapeParameters_HeightmapTexture [[texture(2)]], texture2d<float> LandscapeParameters_XYOffsetmapTexture [[texture(3)]], sampler LandscapeParameters_HeightmapTextureSampler [[sampler(0)]], sampler LandscapeParameters_XYOffsetmapTextureSampler [[sampler(1)]])
{
    ...
    float2 _382 = _349.xy;
    float4 _387 = float4(_381.x, _381.y, _381.z, _381.w);
    float4 _388 = View.View_TranslatedWorldToClip * _387;
    float2 _391 = ((_382 * LandscapeParameters.LandscapeParameters_WeightmapUVScaleBias.xy) + LandscapeParameters.LandscapeParameters_WeightmapUVScaleBias.zw) + _299;
    float2 _395 = (((_382 * LandscapeParameters.LandscapeParameters_HeightmapUVScaleBias.xy) + LandscapeParameters.LandscapeParameters_HeightmapUVScaleBias.zw) + _258) + _263;
    out.out_var_TEXCOORD0 = (_382 + LandscapeParameters.LandscapeParameters_SubsectionSizeVertsLayerUVPan.zw) + _351;
    out.out_var_TEXCOORD1 = float4(_391.x, _391.y, _395.x, _395.y);
    out.out_var_TEXCOORD2 = float4(0.0);
    out.out_var_TEXCOORD6 = _387;
